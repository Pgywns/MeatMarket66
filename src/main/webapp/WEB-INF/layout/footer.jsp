...
<div class="container-fluid bg-dark text-white-50 footer pt-2 mt-2">
            <div class="container py-2">
                <div class="pb-2 mb-2" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                <h1 class="text-primary mb-0">육월육일</h1>
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="mb-4">typesetting, remaining essentially unchanged. It was </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
